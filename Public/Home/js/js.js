...
function move(){
    ...
    if(i<4){
        ...
        if(i==3){
            $('.nav dl dd').eq(i).addClass('bg').siblings().removeClass('bg');
            $('.bannerbox ul li').eq(i).fadeIn(100).siblings().fadeOut();
            $('.banner4-04').animate({opacity:1,"bottom":"0"},225,function(){
                $('.banner4-01').animate({opacity:1,"margin-left":"-360px"},225,function(){
                    $('.banner4-02').animate({opacity:1,"margin-left":"-305px"},225,function(){
                        $('.banner4-03').animate({opacity:1,"margin-left":"-107px"},225);
                    });
                });
            });
        }
